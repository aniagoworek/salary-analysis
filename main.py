...
if __name__ == '__main__':
    ...
    boost_2016_2017, boost_errors_2016_2017 = model_boost(final_training_sets, final_testing_sets, k = 0, n = 29, max_depth = 5, max_features = 1.0, min_samples_leaf = 2, min_samples_split = 15, n_estimators = 120)
    boost_2016_2018, boost_errors_2016_2018 = model_boost(final_training_sets, final_testing_sets, k = 30, n = 59, max_depth = 5, max_features = 1.0, min_samples_leaf = 2, min_samples_split = 15, n_estimators = 210)
    boost_2016_2019, boost_errors_2016_2019 = model_boost(final_training_sets, final_testing_sets, k = 60, n = 89, max_depth = 5, max_features = 1.0, min_samples_leaf = 1, min_samples_split = 15, n_estimators = 180)
    boost_2016_2020, boost_errors_2016_2020 = model_boost(final_training_sets, final_testing_sets, k = 90, n = 119, max_depth = 5, max_features = 1.0, min_samples_leaf = 1, min_samples_split = 10, n_estimators = 240)
    boost_2016_2021, boost_errors_2016_2021 = model_boost(final_training_sets, final_testing_sets, k = 120, n = 149, max_depth = 5, max_features = 1.0, min_samples_leaf = 1, min_samples_split = 15, n_estimators = 270)
    boost_2016_2022, boost_errors_2016_2022 = model_boost(final_training_sets, final_testing_sets, k = 150, n = 179, max_depth = 5, max_features = 1.0, min_samples_leaf = 1, min_samples_split = 15, n_estimators = 240)

    rf_2016_2017, rf_errors_2016_2017 = model_rf(final_training_sets, final_testing_sets, k = 0, n = 29, n_estimators = 200, max_depth = 10, min_samples_split = 5)
    rf_2016_2018, rf_errors_2016_2018 = model_rf(final_training_sets, final_testing_sets, k = 30, n = 59, n_estimators = 200, max_depth = None, min_samples_split = 2)
    rf_2016_2019, rf_errors_2016_2019 = model_rf(final_training_sets, final_testing_sets, k = 60, n = 89, n_estimators = 50, max_depth = 5, min_samples_split = 10)
    rf_2016_2020, rf_errors_2016_2020 = model_rf(final_training_sets, final_testing_sets, k = 90, n = 119, n_estimators = 100, max_depth = 10, min_samples_split = 5)
    rf_2016_2021, rf_errors_2016_2021 = model_rf(final_training_sets, final_testing_sets, k = 120, n = 149, n_estimators = 50, max_depth = 10, min_samples_split = 2)
    rf_2016_2022, rf_errors_2016_2022 = model_rf(final_training_sets, final_testing_sets, k = 150, n = 179, n_estimators = 200, max_depth = None, min_samples_split = 5)

    bagging_2016_2017, bagging_errors_2016_2017 = model_bagging(final_training_sets, final_testing_sets, k = 0, n = 29, bootstrap = True, bootstrap_features = False, max_features = 1.0, max_samples = 1.0, n_estimators = 50)
    bagging_2016_2018, bagging_errors_2016_2018 = model_bagging(final_training_sets, final_testing_sets, k = 30, n = 59, bootstrap = False, bootstrap_features = False, max_features = 1.0, max_samples = 0.7, n_estimators = 50)
    bagging_2016_2019, bagging_errors_2016_2019 = model_bagging(final_training_sets, final_testing_sets, k = 60, n = 89, bootstrap = False, bootstrap_features = False, max_features = 0.7, max_samples = 0.7, n_estimators = 100)
    bagging_2016_2020, bagging_errors_2016_2020 = model_bagging(final_training_sets, final_testing_sets, k = 90, n = 119, bootstrap = True, bootstrap_features = False, max_features = 1.0, max_samples = 1.0, n_estimators = 100)
    bagging_2016_2021, bagging_errors_2016_2021 = model_bagging(final_training_sets, final_testing_sets, k = 120, n = 149, bootstrap = True, bootstrap_features = False, max_features = 1.0, max_samples = 1.0, n_estimators = 50)
